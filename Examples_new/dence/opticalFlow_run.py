...
parser.add_argument("--data_dir_root", type=str,
                    default=r"/home/thippe/ws_slam/ORB_SLAM3/dataset/", help="dataset root")
parser.add_argument("--dataset_type", type=str, default='buggy', choices=['KITTI', 'TUM', 'buggy'], help="dataset type")
parser.add_argument("--len_trajMap", type=int, default=800, help="size of the trajectory map")
...
if __name__ == "__main__":
    ...
    # monitor_cmd = ["python", r"../../../utils/monitor.py", "--pid",
    ...
    seq = '00'
    dataset_reader = DatasetReaderKITTI(args.data_dir_root + 'buggy/seq/' + seq)
    ...
    for frame_no in tqdm(range(1, min(dataset_reader._numFrames, 10000)), desc="Processing frames", unit="frame"):
        ...
        camera_pos = camera_pos + 1 * rotated_T
        ...
        #     continue
        #
        kitti_positions.append(camera_pos)
